...
import 'package:getitgodriver/modules/auth/views/screens/login_screen.dart';
import 'package:getitgodriver/modules/auth/views/screens/otp_verification.dart';
import 'package:getitgodriver/shared/api/api_config.dart';
import 'package:getitgodriver/shared/constants/string.dart';
...
class AuthController extends GetxService {
  ...
  initializeFlow() async {
    // host = "6f7a-2409-40f2-1039-da82-7884-c014-ab1c-f58c.ngrok-free.app";
    host = remoteConfig.getString('${DependencyInject.buildMode}_host');
  ...
  //KYC Verrification
  // PersonalDetail
  Future<http.Response> personalDetail(app_user.PersonalDetail body) async {
    try {
      final response = await BaseHttpProvider()
          .putRequest(Config.submitPersonal, body.toJson());
      _handleResponse(response);
      ...
      debugPrint('personal detail api fault');
      rethrow;
    }
  }
  ...
  Future<http.Response> vehicleDetail(app_user.VehicleDetail body) async {
    try {
      final response = await BaseHttpProvider()
          .putRequest(Config.submitPersonal, body.toJson());
      _handleResponse(response);
      ...
      debugPrint('vehicle detail api fault');
      rethrow;
    }
  }

  //Bank Detail
  Future<http.Response> bankDetail(app_user.BankDetail body) async {
    try {
      final response = await BaseHttpProvider()
          .putRequest(Config.submitPersonal, body.toJson());
      _handleResponse(response);
      ...
      debugPrint('bank detail api fault');
      rethrow;
    }
  }
}
